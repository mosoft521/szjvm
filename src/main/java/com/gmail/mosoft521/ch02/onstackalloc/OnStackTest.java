...
/*
①无VM参数时：
通过-XX:+PrintCommandLineFlags打印虚拟机显式和隐式参数。
-XX:InitialHeapSize=67084160 -XX:MaxHeapSize=1073346560 -XX:+PrintCommandLineFlags
...
③使用参数：
-XX:+PrintCommandLineFlags -server -Xmx10m -Xms10m -XX:+DoEscapeAnalysis -XX:+PrintGC -XX:-UseTLAB  -XX:+EliminateAllocations
打印出：
-XX:+DoEscapeAnalysis -XX:+EliminateAllocations -XX:InitialHeapSize=10485760 -XX:MaxHeapSize=10485760 -XX:+PrintCommandLineFlags
-XX:+PrintGC -XX:+UseCompressedClassPointers -XX:+UseCompressedOops -XX:-UseLargePagesIndividualAllocation -XX:+UseParallelGC -XX:-UseTLAB
[GC (Allocation Failure)  2047K->656K(9728K), 0.0231486 secs]
34

④使用参数：
-XX:+PrintFlagsFinal -server -Xmx10m -Xms10m -XX:+DoEscapeAnalysis -XX:+PrintGC -XX:-UseTLAB  -XX:+EliminateAllocations
